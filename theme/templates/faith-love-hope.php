...
<?php get_template_part('template-parts/custom/custom', 'featured-image'); ?>
 ...
 <h2 class="text-center pt-20 text-primary">[WIP]</h2>
...
<section class="md:py-24 dark:bg-stone-950">
  ...
  <p> We believe that God the Father speaks in the Bible through His Spirit about His Son, Jesus Christ.
</p>
  
<p> We believe that the Bible is God's perfect, authoritative word. In the Bible, God tells us His plan for the world from creation through to the promised new creation. That story is all about Jesus, God’s promised rescuing King, who became one of us, died for our sins and rose again to be enthroned in heaven as Lord of all.


</p>
 
<p>
      We are a wayward people, but by God's love and grace in Jesus, we have been forgiven and adopted into His family, as His children, and called by Him to enjoy, declare and live for His glory.

</p>
 <p>  We believe that the Lord Jesus Christ died on the Cross in our place to grant us complete forgiveness of sin and to bring us to God.
</p>

<p>  We believe that this Good News is at the heart of the Bible which is the sufficient, final and supreme authority in all matters to do with doctrine and life.
   </p>
