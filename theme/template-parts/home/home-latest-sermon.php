...
<h2 class="text-center pb-8 text-foreground entry-title">Latest Sermon</h2>
   ...
   <div class="container text-center pt-14">
     <a href="/sermons" class="btn">View more sermons <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M4 12h12.25L11 6.75l.66-.75l6.5 6.5l-6.5 6.5l-.66-.75L16.25 13H4z"/></svg>
    </a>
   </div>
