<section class=" py-6 md:pt-18 md:pb-32">
    <div class="container">
      ...
      <div class="max text-center pb-8">
       ...
       <p class="mb-4"><?php the_field('visit_description', 'option'); ?></p>
      <p class="mb-4"> <?php the_field('visit_address', 'option'); ?></p>
      </div>
                        ...
                        <div class="flex items-center justify-center gap-4 mt-10">
                            ...
                            if ($link2 && isset($link2['url'])): ?>
                                <a href="<?php echo esc_url($link2['url']); ?>"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="text-primary !ml-16 group-hover:text-white"><path fill="currentColor" d="M4 12h12.25L11 6.75l.66-.75l6.5 6.5l-6.5 6.5l-.66-.75L16.25 13H4z"/></svg>
                                </a>
                            <?php endif; ?>
