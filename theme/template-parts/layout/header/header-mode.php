...
<label aria-label="Toggle light and dark mode" class="inline-block items-center ">
    <input class="sr-only peer darkModeToggle" type="checkbox" />

    <div class="w-20 h-9 rounded-full bg-gray-700 dark:bg-gray-700 relative flex items-center justify-between px-2 transition-colors duration-200">
