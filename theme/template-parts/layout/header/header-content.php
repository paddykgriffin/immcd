...
<header id="masthead" class="bg-white dark:bg-black fixed z-[40] w-full top-0 shadow-xl py-3 dark:border-b dark:border-gray-500">
	...
	<div class="container max-w-[96rem]"> 
		...
		<div class="grid grid-cols-2 md:grid-cols-12 gap-6 justify-between">

			<div class="md:col-span-6 lg:col-span-11 flex gap-6 items-center ">
				<?php
				if ( is_front_page() ) :
					?>
						<a href="<?php echo esc_url(home_url('/')); ?>" rel="home" class="hover:opacity-50 transition-all duration-300">
								<img src="<?php bloginfo('template_directory'); ?>/img/logo.png" alt="<?php bloginfo('name'); ?>" class="w-16 lg:w-24" />
							</a>	
					<?php
				else :
					?>
				...
				<nav id="site-navigation" aria-label="<?php esc_attr_e( 'Main Navigation', 'immanuel-church-dublin' ); ?>" class="pl-6 flex ">
					<?php
					wp_nav_menu( 
						array(
							...
							'menu_class' => ' gap-12 lg:gap-8 2xl:gap-12 hidden lg:flex ', 
			...
			<div class="md:col-span-6 lg:col-span-1 grid items-center">
